export default function CurrentCard(props) {
    return (
        <div 
            ...
            data-aos-offset="100" 
            className="w-full md:w-11/12 md:m-auto p-4 text-center justify-center bg-dark-200 rounded-md flex flex-col h-104 md:h-80 lg:h-96 tracking-wide md:tracking-normal"
        >
