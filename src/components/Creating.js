            ...
            <div className="mt-4">
                <Slider {...settings}>
                    <CreatingCard
                        name="Reactjs"
                        subtitle="React 18"
                        content="I choose to use Reactjs for this project as it is (to me) a new tool. Working with the different files and components provided a challenge that I would otherwise have not faced with HTML. Some issues arose when I had to connect to php and sql, but XAMPP was able to fix those issues."
                        img={react}
                    />
                    <CreatingCard
                        name="Tailwindcss"
                        subtitle="Tailwind 3.2"
                        content="I have grown accustomed to using this framework, it allows me to easily change css attributes from the html elements directly."
                        img={tailwind}
                    />
                    <CreatingCard
                        name="XAMPP"
                        subtitle="Stable release 8.2.4"
                        content="XAMPP allowed me to connect to a phpmyadmin page, rather than projectspace."
                        img={xampp}
                    />
                </Slider>
