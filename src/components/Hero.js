...
export default function Hero () {
    ...
    return (
        <>
        {loaded ? <div className="fixed top-0 left-0 right-0 bottom-0 w-full h-screen z-50 overflow-hidden bg-white flex flex-col items-center justify-center">Loading...</div> : null}
        <div id="home" className="flex w-full h-screen flex-col md:flex-row gap-5 items-center justify-center text-white relative snap-both">
            ...
            <div className='md:w-3/6' data-aos="fade-right" data-aos-duration="1000" data-aos-offset="100" >
                ...
                <ul className='flex mt-2 gap-4 items-center'>
                   <li><a href='https://github.com/ryanjcronin5/dtcMain' rel="noreferrer" target="_blank"><FontAwesomeIcon size='2xl' icon={faGithub} /></a></li> 
                </ul>
            </div>
