...
export default function DiscCard6(props) {
    ...
    return (
        <div data-aos={window.innerWidth > 768 ? 'fade-up' : null} data-aos-duration="500" data-aos-offset="100" className="hover:bg-dark w-fit h-full bg-dark-200 rounded-md py-4 px-4 md:m-4 tracking-wide md:tracking-normal text-boxColor">
            <div>
